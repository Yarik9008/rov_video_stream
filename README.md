...
**Настройки по умолчанию** (720p для оптимальной производительности):
...
- FPS: 30
- Битрейт: автоматический расчет (~7 Mbps для 720p@30fps)
- Задержка: минимальная

### Дополнительные опции

```bash
# Исходное разрешение источника
...
**Важно**: 
- По умолчанию используется 720p (1280x720) для оптимальной производительности
- Битрейт рассчитывается автоматически на основе разрешения и FPS
- Для исходного разрешения источника используйте `--width 0 --height 0`
...
- **--width/--height**: разрешение кадра (по умолчанию `1280x720` = 720p; `0` = исходное разрешение)
