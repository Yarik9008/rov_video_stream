...
**Важно**: 
- По умолчанию используется исходное разрешение источника (без ресайза) для максимального качества
...
- **--width/--height**: разрешение кадра (по умолчанию `0` = исходное разрешение для максимального качества)
